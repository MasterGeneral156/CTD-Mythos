...
public class ModBlocks extends RegisterBlock
{
    ...
    {
        crystal_fire_ore = register(new OreBlock("crystal_fire_ore", ModItems.crystal_fire));
        crystal_grief_ore = register(new OreBlock("crystal_grief_ore", ModItems.crystal_grief));
        crystal_memory_ore = register(new OreBlock("crystal_memory_ore", ModItems.crystal_memory));
        crystal_oath_ore = register(new OreBlock("crystal_oath_ore", ModItems.crystal_oath));
        crystal_woe_ore = register(new OreBlock("crystal_woe_ore", ModItems.crystal_woe));
