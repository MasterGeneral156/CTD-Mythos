...
public class WandFlightItems {
	...
	public void addFlight(ItemStack input, int flighttime, int flightmultiplier, int resistancetime)
	{
		this.addFlightItem(input, flighttime, flightmultiplier, resistancetime);
	}
	
	public void addFlightItem(ItemStack input, int flighttime, int flightmultiplier, int resistancetime)
	{
