...
public class CrystallizedOath extends CrystalBase
{
            ...
            EntityPlayer playerIn, EnumHand handIn)
    {
        ...
        {
        	//Desert biomes only.
        	if (worldIn.getBiome(playerIn.getPosition()) instanceof BiomeDesert)
    		{
        	...
        	{
        		playerIn.sendStatusMessage(new TextComponentString("This may only be done in a Desert-based biome."), true);
        	}
		}
